...
1. Tweet Collection/Cleaning:
	i) retrieve_tweets.py
...
In sum, the following commands were passed in the project_main directory to obtain and process the data used in this project. 
All commands appear in the order in which they are called. 
Make sure the 'retrieval_windows.txt' file has correct, updated dates.
Standard Twitter API access only allows users retrieve tweets from the last 7 days.
